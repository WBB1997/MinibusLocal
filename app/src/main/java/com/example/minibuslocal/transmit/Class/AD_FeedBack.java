...
public class AD_FeedBack extends BaseClass {
    private static final String TAG = "AD_FeedBack";
    private HashMap<Integer, MyPair<Integer>> fields = new HashMap<Integer, MyPair<Integer>>(){{
        put(0,new MyPair<>(2, IntegerCommand.AD_MainControlChangeFeedBack, MainActivity.SEND_TO_LOCALHOST)); // 档位位置;
    }};
